...
def main():
    ...
    out={'iteration':'MDL-1','status':'CANDIDATES_PREFLIGHT_PASS','approval_status':'PENDING_HUMAN_SELECTION','candidate_completeness':{slot['asset_id']:len(slot['candidates']) >= slot['required_candidates'] for slot in plan['slots']},'candidates':candidates}
