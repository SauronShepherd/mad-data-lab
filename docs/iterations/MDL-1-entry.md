...
| MDL1-ENTRY-004 | GitHub Actions enablement and required checks are not verifiable. | Actions/settings or accepted CI run required | BLOCKED | External GitHub evidence missing. |
